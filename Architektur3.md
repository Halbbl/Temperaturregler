...
Hinsichtlich der Architektur hat sich auch in der dritten Iteration nichts geändert, wodurch in dieser Datei nichts anderes steht als in `Architektur1` & `Architektur2`.
