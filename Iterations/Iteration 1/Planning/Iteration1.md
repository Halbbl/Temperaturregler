...
Diese Funktionen wurden hinsichtlich der realistischen Nutzung des Endprodukts ausgewählt. 
...
<<<<<<<< HEAD:out/production/Temperaturregler/Iteration1/Iteration1.md
...
========
Req. 1.1: Automatisches aktivieren des Heizlüfters, wenn Raumtemperatur max. 1°C kälter ist als gewünschte Temperatur <br>
Req. 1.2: Automatisches deaktivieren des Heizlüfters bei Erreichen der gewünschten Temperatur <br>
Req. 1.3: Halten der gewünschten Temperatur mit Schwankungen bis max. 1°C <br>
Req. 1.4: Temperatursimulation sollte Temperatur hoch bzw. runtergehen lassen <br>
Req. 1.5: Temperatursimulation sollte Grenzen (max, min) nicht überschreiten <br>
>>>>>>>> e8be0b7 (transferred final state from se repository):Iterations/Iteration 1/Planning/Iteration1.md


**Benutzeroberfläche:**

Req. 1.6: Anzeige der aktuellen Raumtemperatur <br>
Req. 1.7: Möglichkeit zum Ändern der gewünschten Temperatur <br>
Req. 1.8: Ändern der Benutzeroberfläche bei Interaktion des Nutzers <br>
Req. 1.9: Intuitive Benutzeroberfläche <br>
Req. 1.10: Abfangen von nicht genehmigten Input Variablen <br>
...
========
Kern der Anwendung bilden. Dazu gehörten die Startklasse `Main`, der 
Temperatursimulator `TemperatureSimulation`, 
der Temperatursensor `TemperatureSensor`, der 
Heizlüfter (Heater), der zentrale Verwaltungsmechanismus
`ComponentsManager` sowie die Benutzeroberfläche
`FanHeaterUI`. <br>
>>>>>>>> e8be0b7 (transferred final state from se repository):Iterations/Iteration 1/Planning/Iteration1.md
...
Klassendiagramm visualisiert werden. Dieses kann man in `Design1` finden. <br>
...
========
Nach der Implementation wurden Test basierend auf den Requirements durchgeführt. Alle Tests und deren Ergebnisse 
befinden sich in `TestReport1`.


### 5. Review

Zuletzt wurde eine reflektiert und alle gewonnenen Erkenntnisse in `Retrospective1` festgehalten.
>>>>>>>> e8be0b7 (transferred final state from se repository):Iterations/Iteration 1/Planning/Iteration1.md
